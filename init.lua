...
vim.opt.number = true
-- Add relative line numbers for quick jumps
...
-- Double esc to exit term. This won't work in all terminal emulators/tmux/etc.
...
-- Copy current file's directory path to clipboard
vim.keymap.set('n', '<leader>cd', function()
  local file_dir = vim.fn.expand '%:p:h'
  vim.fn.setreg('+', file_dir)
  print('File directory copied to clipboard: ' .. file_dir)
end, { desc = '[C]opy file [D]irectory to clipboard' })
